    ...
    return(
        <div className = {styles.container}>
            ...
            <div className = {styles.history}>
                ...
                <p>
                    The History page will allow our users to see their for past purchases as well as
                    as any warranties they may have purchased with a specific item. They will also be able to
