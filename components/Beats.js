            ...
            <Grid item xs={9} sm={10}>
                <Grid container={'true'}>
                    ...
                    <Grid item xs={12} className={styles.itemName}>
                        <Typography variant="h6" classes={styles.itemName}><b>Beats Studio 3</b></Typography>
                    </Grid>
                    <Grid item xs={12} className={styles.itemPrice}>
                        <Typography variant="subtitle1"><b>$349.95</b></Typography>
                        {/* INSERT RATING HERE */}
                    </Grid>
                    <Grid item xs={12} className={styles.itemDesc}>
                        <Typography><b>Color:</b> midnight black/orange</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container>
                            <Grid item xs={4}>
